...
'''
new Env('京东自动评价');
cron: 40 8 * * *  python3 jd_Evaluation.py
'''
import os
import random
import re
...
NeedEvaluation = []
if 'NeedEvaluation' in os.environ:
    pt_pin = os.environ['NeedEvaluation'].split('&')
    for x in pt_pin:
        NeedEvaluation.append(pt_pin[x])
